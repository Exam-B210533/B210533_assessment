...
# The Category_2 list is long and would be easier to read in columns
# The following code creates a four columns viewed side by side
unique_cat2 = unique(mort[c("category_2")])
...
# Create subset for Marker to test the tool and save
